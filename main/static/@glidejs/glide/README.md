...
```js
import Glide from 'portfolio/main/static/@glidejs/glide/dist/glide.esm'
...
```js
import Glide, {Controls, Breakpoints} from 'portfolio/main/static/@glidejs/glide/dist/glide.modular.esm'
